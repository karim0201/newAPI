...
public class Reporting implements ITestListener{
	...
	public void onStart(ITestContext testContext) {
		...
		htmlReporter.config().setDocumentTitle("Employee Data Test Report"); //Title of report
		htmlReporter.config().setReportName("Rest Assured API Automation Report"); //Name of the report
